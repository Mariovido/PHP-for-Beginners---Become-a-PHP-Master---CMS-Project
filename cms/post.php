    ...
    <div class="col-md-8">
      ...
      if (isset($_GET['p_id'])) {
        ...
        if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
          ...
          $view_query = "UPDATE posts SET post_views_count = post_views_count + 1 WHERE idposts = $the_post_id";
        ...
        $query = "SELECT * FROM posts WHERE idposts = {$the_post_id}";
      ...
      if ($_SERVER['REQUEST_METHOD'] === "POST") {
        ...
        if (isset($_POST['create_comment'])) {
          ...
          if (!empty($comment_author) && !empty($comment_email) && !empty($comment_content)) {
            ...
            // $query .= "WHERE idposts = $the_post_id";
      ...
      <div class="well">
        ...
        <form role="form" action="" method="post">
          <input type="hidden" value="<?php echo isset($the_post_id) ?? null; ?>">
      ...
      $query .= "ORDER BY idcomments DESC";
